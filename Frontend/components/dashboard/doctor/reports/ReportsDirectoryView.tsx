...
interface ReportsDirectoryViewProps {
    initialData: ReportMock[];
}

export function ReportsDirectoryView({ initialData }: ReportsDirectoryViewProps) {
    ...
    const { data: reports = initialData, isLoading } = useQuery({
    ...
    const filteredReports = reports.filter((r: ReportMock) => {
