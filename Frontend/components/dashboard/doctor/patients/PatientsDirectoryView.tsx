...
export function PatientsDirectoryView({ initialData }: PatientsDirectoryViewProps) {
    ...
    const { data: patients = initialData, isLoading } = useQuery({
    ...
    const filteredPatients = patients.filter((p: PatientListItem) => {
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-700">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <Button
                    ...
                    className="h-10 border-slate-200/60 font-inter bg-white font-bold text-black hover:bg-teal-50 hover:text-teal-600 transition-colors shadow-sm"
                >
