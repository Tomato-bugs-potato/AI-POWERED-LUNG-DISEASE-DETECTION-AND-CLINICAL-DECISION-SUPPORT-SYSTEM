...
interface UsersDashboardViewProps {
...
export function UsersDashboardView({ initialUsers }: UsersDashboardViewProps) {
    ...
    const handleRoleChange = (userId: string, newRoleValue: string) => {
        handleRoleChangeMutation(userId, newRoleValue);
    };

    const handleRoleChangeMutation = (userId: string, newRoleValue: string) => {
